...
export const env = {
  ...
  /**
   * The one address allowed to hold an operator session. The password
   * belongs to the Supabase Auth user for this address — set and changed
   * in the Supabase dashboard, never in the environment.
   */
  get OPERATOR_EMAIL() {
